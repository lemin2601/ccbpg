window.__require = function e(t, n, r) {
    ...
    cc.Class({
      ...
      init: function init() {
        ...
        this._am.setVerifyCallback(function(path, asset) {
          ...
          cc.log("Verification passed : " + relativePath + " (" + expectedMD5 + ")" + md5);
          return true;
        });
      ...
      updateCb: function updateCb(event) {
        ...
        switch (event.getEventCode()) {
         ...
         case jsb.EventAssetsManager.UPDATE_PROGRESSION:
          cc.log(event.getPercent() + "|" + event.getPercentByFile() + "|" + event.getDownloadedFiles() + "|" + event.getTotalFiles() + "|" + event.getDownloadedBytes() + "|" + event.getTotalBytes() + "|" + event.getMessage());
          break;
      ...
      checkUpdate: function checkUpdate() {
        if (!cc.sys.isNative) {
          cc.log("is not native, so not have check update");
          return;
        }
        if (this._updating) {
        ...
        if (this._am.getState() === jsb.AssetsManager.State.UNINITED) {
          ...
          var textValue = jsb.fileUtils.getStringFromFile("project.manifest");
          cc.log(textValue);
          ...
          cc.log(JSON.stringify(manifest.getPackageUrl()));
          cc.log(JSON.stringify(manifest.getManifestFileUrl()));
        }
  ...
  Log: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a5a545zsFxI/L4OrDsMyWso", "Log");
    "use strict";
    var Log = {
      isDebug: true,
      log: function log() {
  ...
  MConfig: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d4413kHWG9HLIJD25jcD1fx", "MConfig");
    "use strict";
    var MConfig = {
  ...
  MGame: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "72f72r5PNtPD7P+avgkV2sT", "MGame");
    "use strict";
    var EventName = require("EventName");
    var MGame = {
      load: function load() {
      ...
      sendCheckBeforeUpdate: function sendCheckBeforeUpdate(callbackDone) {
        ...
        var url = MConfig.urlServices + "/check-need-update.html?game=" + MConfig.gameName + "&code=1";
  ...
  MGlobal: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b1b79iA3f5NOoMhRHmzYaQL", "MGlobal");
    "use strict";
    cc.Class({
  ...
  MStorage: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8684dkczLRJqotF00Mkg3JC", "MStorage");
    "use strict";
    var MStorageKey = {
    ...
    var MStorage = {
      ...
      get: function get(key, valueDefault) {
        var value = void 0;
        null == key ? void 0 !== valueDefault && (value = valueDefault) : value = localStorage.getItem(key);
        return value;
      },
      getBoolean: function getBoolean(key, valueDefault) {
        var value = this.get(key, valueDefault);
        if (null == value) if (void 0 !== valueDefault) {
          "boolean" !== typeof valueDefault && cc.error("MStorage: getBoolean %s-%s, default value not is boolean value", key, valueDefault);
          value = valueDefault;
        } else value = false; else value = "true" === value;
        return value;
      },
      setBoolean: function setBoolean(key, value) {
        var msgSave = "false";
        if ("boolean" === typeof value) msgSave = value ? "true" : "false"; else {
  ...
  NetworkUtils: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "84d361DTe1PmpeD92+t7CWv", "NetworkUtils");
    "use strict";
    var NetworkUtils = {
  ...
  SceneLoading: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a81c1ftUhJLALFhaobMUPbR", "SceneLoading");
    "use strict";
    var crypto = require("crypto");
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        var sprite = this.progressBar.getContentSize();
      ...
      afterCheckUpdateResource: function afterCheckUpdateResource(event) {
      ...
      afterLoadDone: function afterLoadDone() {
        cc.director.preloadScene("SceneMenu", function(completedCount, totalCount, item) {}, function(error) {
